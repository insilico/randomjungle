...
/***********************************************************************
 * This header contains all source code due to template coding.
 * GCC can not handle template code in cpp/h combination adequatley.
 * This is the securest way of integrating templates.
 * Nevertheless, it can increase build/link time.
 ***********************************************************************/
