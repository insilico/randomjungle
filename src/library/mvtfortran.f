*
*    $Id: mvt.f 194 2009-03-17 10:28:54Z thothorn $
*
*    modified 2009/04/07 df schwarz
*
#include "config.h"
...
*
*     GSLPOINTER This is a pointer hack to pass gsl pointer through routines.
*            Size of pointer has to be determined before, i.e. in
*            configure script. (8 == 64 bit)
*
      EXTERNAL MVSUBR
     ...
     &                 ABSEPS, ERROR, VALUE, E(1), V(1)
      COMMON /PTBLCK/IVLS
      CHARACTER*SIZEOF_VOID_P GSLPOINTER
      IVLS = 0
...
*
*     use gsl rng instead of R's random number generator.
*
...
*      X = unifrnd()
      RET = gsl_rng_uniform_fortran(X, GSLPOINTER)
      MVUNI = X
      END
