...
void randomJungle(RJunglePar par) {
  ...
  // reset some parameters if mpi is enabled
  if (par.mpiId != 0)
		par.verbose_flag = 0;
...
void __cdecl testLibrandomjungle() {
  ...
  tester.helpers();
  tester.lr();
  tester.testSClassAtom();
  tester.testC_maxabsConditionalPvalue();
  tester.testMvt();
  tester.testCI();

  //tester.testT2ClassAtom();
  //tester.testTMClassAtom();
  //tester.testNode();
  //tester.testDataFrame();
  //tester.testFind();
  //tester.testDataFrameAndNode();
  //tester.testPurity();
  //tester.testGini1();
  //tester.testGini2();
  //tester.testTree();
  //tester.testJTreeCtrl4();
  //tester.testJTreeCtrl5();
  //tester.testRandomJungleCtrl1();//double
  //tester.testRandomJungleCtrl2();//short int
}
...
RJunglePar __cdecl initRJunglePar() {
  ...
  par.extractdata_flag = false;
	par.classweights = (char *) "";
  par.yaimp_flag = false;
  par.gwa_flag = false;
